...
class __TwigTemplate_5b67802daf16bfa8af209c6d65826e78b8e876122d94455e1d44a8eda3be897a extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_title($context, array $blocks = [])
    {
        ...
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("title.page.new.department"), "html", null, true);
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        echo "\" method=\"POST\">
                    ";
        // line 12
        $this->loadTemplate("department/_form.html.twig", "department/new.html.twig", 12)->display(twig_to_array(["form" => (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 12, $this->source); })())]));
        // line 13
...
{% block title %}{{ 'title.page.new.department'|trans }}{% endblock %}
...
{% block body %}
    <div class=\"row\">
        <div class=\"col-md-12\">
            ...
            <div class=\"card card-default\">
                <!-- form start -->
                <form id=\"departmentForm\" action=\"{{ path('department_new') }}\" method=\"POST\">
...
{% endblock %}", "department/new.html.twig", "/var/www/project/templates/department/new.html.twig");
    }
}
