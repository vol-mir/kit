...
/* unit/new.html.twig */
class __TwigTemplate_a24f1844ef1e59b5de92454c4d11821024ea9119494963a2d2a3a702410ca1b2 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_title($context, array $blocks = [])
    {
        ...
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("title.page.new.unit"), "html", null, true);
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        echo "\" method=\"POST\">
                    ";
        // line 12
        $this->loadTemplate("unit/_form.html.twig", "unit/new.html.twig", 12)->display(twig_to_array(["form" => (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 12, $this->source); })())]));
        // line 13
...
{% block title %}{{ 'title.page.new.unit'|trans }}{% endblock %}
...
{% block body %}
    <div class=\"row\">
        <div class=\"col-md-12\">
            ...
            <div class=\"card card-default\">
                <!-- form start -->
                <form id=\"unitForm\" action=\"{{ path('unit_new') }}\" method=\"POST\">
...
{% endblock %}", "unit/new.html.twig", "/var/www/project/templates/unit/new.html.twig");
    }
}
