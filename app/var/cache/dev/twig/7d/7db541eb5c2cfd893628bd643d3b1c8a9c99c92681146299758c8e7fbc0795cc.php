...
class __TwigTemplate_ad133265fced20d69c5b9cc779ec8dc5e9104f91a1cb04e0b171fad820be7d46 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $this->parent = $this->loadTemplate("base.html.twig", "product_type/index.html.twig", 1);
        ...
        <div class=\"col-12\">
            <div class=\"card\">
                <div class=\"card-header\">
                    ";
        // line 10
        $this->loadTemplate("product_type/_controls.html.twig", "product_type/index.html.twig", 10)->display($context);
        // line 11
        echo "                </div>
                <!-- /.card-header -->
                <div class=\"card-body\">
                    <table id=\"productTypes\" class=\"table table-bordered table-striped table-hover table-sm\">
                        <thead>
                        <tr>
                            <th>Наименование</th>
                            <th width=\"5%\"></th>
                ...
                <div class=\"card-footer\">
                    ";
        // line 33
        $this->loadTemplate("product_type/_controls.html.twig", "product_type/index.html.twig", 33)->display($context);
        // line 34
        echo "                </div>
                <!-- /.card-footer -->
            </div>
    ...
    ";
        // line 43
        $this->loadTemplate("modals/delete.html.twig", "product_type/index.html.twig", 43)->display($context);
    ...
    public function block_javascripts($context, array $blocks = [])
    {
        ...
        echo "    <script>
        \$(function () {
            let table = \$(\"#productTypes\").DataTable({
                \"columnDefs\": [
                ...
                \"ajax\": {
                    \"url\": \"";
        // line 57
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("product_type_datatables");
        echo "\",
                    \"type\": \"POST\"
                },
                \"stateSave\": true,
        ...
        echo "\"
            ...
            \$(\"#productTypes\").on(\"click\", \".modal-delete-dialog\", function () {
            ...
            \$(\"#modal-delete\").on(\"click\", \"#btn-modal-delete\", function () {
                ...
                let url = \"";
        // line 83
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("product_type_delete", ["id" => 0]);
        echo "\";
...
{% block title %}{{ 'title.page.index.product_type'|trans }}{% endblock %}
...
{% block body %}
    <div class=\"row\">
        <div class=\"col-12\">
            <div class=\"card\">
                <div class=\"card-header\">
                    {% include 'product_type/_controls.html.twig' %}
                </div>
                <!-- /.card-header -->
                <div class=\"card-body\">
                    <table id=\"productTypes\" class=\"table table-bordered table-striped table-hover table-sm\">
    ...
    <script>
        \$(function () {
            let table = \$(\"#productTypes\").DataTable({
                ...
                \"ajax\": {
                    \"url\": \"{{ path('product_type_datatables') }}\",
                    \"type\": \"POST\"
                },
                \"stateSave\": true,
                \"processing\": true,
            ...
            \$(\"#modal-delete\").on(\"click\", \"#btn-modal-delete\", function () {
                ...
                let url = \"{{ path('product_type_delete', { 'id': 0 }) }}\";
                url = url.replace(\"0\", \$(this).attr('data-confirm-delete-id'));
...
{% endblock %}", "product_type/index.html.twig", "/var/www/project/templates/product_type/index.html.twig");
    }
}
