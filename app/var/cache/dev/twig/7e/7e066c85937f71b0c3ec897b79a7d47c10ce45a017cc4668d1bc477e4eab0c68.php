...
class __TwigTemplate_8a7fb412e23644aea93b6b0ab47442adf4a5754491b98908ab006f5ed173c4c7 extends Template
{
    private $source;
    private $macros = [];
        ...
        <div class=\"col-12\">
            <div class=\"card\">
                <div class=\"card-header\">
                    ";
        // line 10
        $this->loadTemplate("unit/_controls.html.twig", "unit/index.html.twig", 10)->display($context);
        // line 11
        echo "                </div>
                <!-- /.card-header -->
                <div class=\"card-body\">
                    <table id=\"units\" class=\"table table-bordered table-striped table-hover table-sm\">
                        <thead>
                        <tr>
                            <th>Наименование</th>
                            <th></th>
                ...
                <div class=\"card-footer\">
                    ";
        // line 33
        $this->loadTemplate("unit/_controls.html.twig", "unit/index.html.twig", 33)->display($context);
        // line 34
        echo "                </div>
                <!-- /.card-footer -->
            </div>
    ...
    ";
        // line 43
        $this->loadTemplate("modals/delete.html.twig", "unit/index.html.twig", 43)->display($context);
    ...
    public function block_javascripts($context, array $blocks = [])
    {
        ...
        \$(function () {
            let table = \$(\"#units\").DataTable({
                ...
                \"ajax\": {
                    \"url\": \"";
        // line 57
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("unit_datatables");
        echo "\",
                    \"type\": \"POST\"
                },
                \"stateSave\": true,
        ...
        echo "\"
            ...
            \$(\"#units\").on(\"click\", \".modal-delete-dialog\", function () {
            ...
            \$(\"#modal-delete\").on(\"click\", \"#btn-modal-delete\", function () {
                ...
                let url = \"";
        // line 83
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("unit_delete", ["id" => 0]);
        echo "\";
...
{% block title %}{{ 'title.page.index.unit'|trans }}{% endblock %}
...
{% block body %}
    <div class=\"row\">
        <div class=\"col-12\">
            <div class=\"card\">
                <div class=\"card-header\">
                    {% include 'unit/_controls.html.twig' %}
                </div>
                <!-- /.card-header -->
                <div class=\"card-body\">
                    <table id=\"units\" class=\"table table-bordered table-striped table-hover table-sm\">
...
{% endblock %}", "unit/index.html.twig", "/var/www/project/templates/unit/index.html.twig");
    }
}
