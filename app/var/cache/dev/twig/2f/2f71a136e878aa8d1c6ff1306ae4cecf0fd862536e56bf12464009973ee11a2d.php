...
/* default/table_group_btn_structure.html.twig */
class __TwigTemplate_ed5a5709ed82af8506ea8f73ce290410472598a8b818c3c351b0cb1110034799 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $__internal_085b0142806202599c7fe3b329164a92397d8978207a37e79d70b8c52599e33e->enter($__internal_085b0142806202599c7fe3b329164a92397d8978207a37e79d70b8c52599e33e_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "default/table_group_btn_structure.html.twig"));

        $__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02 = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02->enter($__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "default/table_group_btn_structure.html.twig"));
    ...
    ";
        ...
        if ((isset($context["idUp"]) || array_key_exists("idUp", $context) ? $context["idUp"] : (function () { throw new RuntimeError('Variable "idUp" does not exist.', 2, $this->source); })())) {
            // line 3
            echo "    <button type='button' class='btn btn-sm btn-default structure-up'
            data-id='";
            // line 4
    ...
    ";
        ...
        if ((isset($context["idDown"]) || array_key_exists("idDown", $context) ? $context["idDown"] : (function () { throw new RuntimeError('Variable "idDown" does not exist.', 6, $this->source); })())) {
            // line 7
            echo "    <button type='button' class='btn btn-sm btn-default structure-adown'
            data-id='";
            // line 8
    ...
    ";
        ...
        if ((isset($context["idMove"]) || array_key_exists("idMove", $context) ? $context["idMove"] : (function () { throw new RuntimeError('Variable "idMove" does not exist.', 10, $this->source); })())) {
            // line 11
            echo "    <button type='button' class='btn btn-sm btn-default structure-move'
            data-id='";
            // line 12
...
\t";
    ...
    {
        return "default/table_group_btn_structure.html.twig";
    }
    ...
    {% if idUp %}
    <button type='button' class='btn btn-sm btn-default structure-up'
            data-id='{{ idUp }}' title=\"Вверх\"><i class='fas fa-arrow-up'></i></button>
    {% endif %}
    {% if idDown %}
    <button type='button' class='btn btn-sm btn-default structure-adown'
            data-id='{{ idDown }}' title=\"Вниз\"><i class='fas fa-arrow-down'></i></button>
    {% endif %}
    {% if idMove %}
    <button type='button' class='btn btn-sm btn-default structure-move'
...
</div>", "default/table_group_btn_structure.html.twig", "/var/www/project/templates/default/table_group_btn_structure.html.twig");
    }
}
